...
instantiate_qgemm("qgemm_iq2_s", iq2_s, 2, 16);
instantiate_qgemm("qgemm_iq3_s", iq3_s, 2, 16);
instantiate_qgemm("qgemm_iq1_m", iq1_m, 2, 16);
...
instantiate_qgemm_frag("qgemm_frag_iq2_s", iq2_s);
instantiate_qgemm_frag("qgemm_frag_iq3_s", iq3_s);
instantiate_qgemm_frag("qgemm_frag_iq1_m", iq1_m);
